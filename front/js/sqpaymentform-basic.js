...
// var applicationId = "sq0idp-njupXCsaDJGhlBbl2zzeZg";
var applicationId = "sandbox-sq0idp-njupXCsaDJGhlBbl2zzeZg";

// Set the location ID
var locationId = "CBASELhxC7jDvbPyWveYkfNjnK4gAQ";
    ...
    cardNonceResponseReceived: function (errors, nonce, cardData) {
      if (errors) {
        ...
        errors.forEach(function (error) {
          ...
          $(".payment-errors").show();
          $(".payment-errors").html('<h2>'+error.message+'</h2>');
          $("#overlay").hide();
        });
