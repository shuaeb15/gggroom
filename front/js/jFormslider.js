...
$.fn.jFormslider=function(options)
{
	...
	// if($(this).find('li:last').hasAttr('call-before'))
	// {
	// 	alert("Asdf");
	// 	var func=$(this).find('li:last').attr('call-before');
	// 	eval(func);
	// }
	...
	$.fn.nextSlide=function(){
		...
		if(slidestart)
		{
				if(next_slide.hasAttr('call-before'))
				{
					...
					{
						if(btn == true){
							$('#slider ul li').append('<div class="finish-button" style="display:block !important;"><input type="submit" class="btn btn-success" id="finish" name="finish" value="finish" style="float:right"></div>');
