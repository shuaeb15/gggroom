/*
	...
	*	How to Use:
		...
		In Body Section:
		Select Country:   <select onchange="putAllStateOptions('state',this.selectedIndex);" id="country" name ="country"></select>
		<br />
		City/District/State: <select name ="state" id ="state"></select>
		<script language="javascript">putAllCountryOptions("country");</script>	
*/
...
s_a[236]="Ajman|Abu Dhabi|Fujairah|Sharjah|Dubai|Ras al-Khaimah|Umm al-Quwain";
...
function putAllCountryOptions(country_id,selectedCountry,stateSelectboxId,selectedState){
    ...
    for (var i=0; i<country_arr.length; i++) {
        ...
        if(country_arr[i] == selectedCountry)
        {
    ...
    if(current_selected_index!='')
        putAllStateOptions(stateSelectboxId,current_selected_index,selectedState);
}
function putAllStateOptions(state_id, state_index,selectedState){
