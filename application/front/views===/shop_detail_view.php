...
<input type="hidden" name="shop_id" id="shop_id" value="<?=$this->uri->segment(4)?>">
<div class="container">
    ...
    <div class="col-md-7">
      <div class="product_details">
        ...
        <div class="cmpny_details">
         ...
         <?php }?>
             <a class="btn-link-a" href="<?=site_url()?>appointment/appointment_step1/<?=$this->uri->segment(3)?>/<?=$this->uri->segment(5)?>"><div class="button_link1">BOOK NOW</div></a>
         </div>
         <?php }?>
