                ...
                <div class="edit-form shop-form">
                  ...
                  <div class="col-md-6 col-xs-12">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control no-border cls-worker-info" Placeholder="Worker Name *" name="worker_name" id="worker_name" value="">
                    </div>
                  </div>
                  <div class="col-md-6 col-xs-12">
                    <div class="form-group">
                    ...
                    <div class="business_hrs">
                      <div class="col-md-12 col-xs-12">
                        ...
                        <div class="col-md-1 col-xs-6 business_hrs_inner">
                          <input type="checkbox" name="shop_name[]" id="radio<?=$i?>" class="css-checkbox" value="<?=$shop->id?>">
              ...
              <div class="edit-form shop-form">
               ...
               <div class="col-md-12 vacation_module" style="display:none;">
                  <div class="col-md-12">
                     ...
                     <div class="col-md-3">
                      <input type="text" name="vacation_start_date" id="vacation_start_date" class="select_date">
                     </div>
                     <!-- <div class="col-md-3">
                      ...
                      <div id="datepairExample1">
                        <input type="text" class="time start ui-timepicker-input cls-time-input form-control" id="vacation_start_time" name="vacation_start_time">
                      </div>
                  </div>
                  <div class="col-md-12">
                     <div class="col-md-3" style="margin: 5px 0 20px 0">
