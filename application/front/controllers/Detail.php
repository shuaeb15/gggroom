...
class Detail extends MY_Controller {
    ...
    public function shop_detail() {
      ...
      $service_list->shop_id = $this->uri->segment(3);
      $ashop_id = $this->uri->segment(3);
      ...
      $service_list = $this->general_model->get_service_data_id_shop_name('services', array('services.id' => $service_id, 'services.is_deleted' => 0),$ashop_id);
