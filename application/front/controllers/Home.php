...
class Home extends MY_Controller {
      ...
      $this->data['footer_pages3'] = $footer_pages3;
        ...
        foreach ($main_filter_shop_list as $key => $value) {
          // $main_services = $this->general_model->get_service_data_by_worker_shopid( 'services', array('services.id' => $value->id, 'services.shop_id' => $value->shop_id,'workers.shop_id' => $value->shop_id, 'services.is_deleted' => 0, 'workers.is_deleted' => 0, 'shop.is_deleted' => 0, 'user.u_category' => 2));
           ...
           $main_services = $this->general_model->get_service_data_by_worker_shopid( 'services', array('services.id' => $value->id, 'services.is_deleted' => 0),$value->shop_id);
    ...
    public function filter_services(){ 
     ...
     //print_r($all_main_filter_shop_list); die();

      $check_worker_service = $start;
      $start_rec = $start;

      // $filter_data1_old = $this->general_model->get_filter_data_list_main('services', array('services.is_deleted' => 0, 'user.u_category' => 2), $filter_services,$filter_shops, $filter_sorting, $main_date, $filter_min_price, $filter_max_price, $filter_location);
    ...
    // echo '<pre>'; print_r($filter_data1);exit;
     ...
     // $limit = 20;
      ...
      $main_filter_shop_list = $this->general_model->get_filter_data_list('services', array('services.is_deleted' => 0), $filter_services,$filter_shops, $filter_sorting, $main_date, $filter_min_price, $filter_max_price, $filter_location, $limit, $start_rec);
     ...
     //echo '<pre>'; print_r($main_filter_shop_list);exit;
      ...
      foreach ($main_filter_shop_list as $key => $value) {
       ...
       // echo $value->id;
        ...
        //echo '<pre>'; print_r($main_services);exit;
