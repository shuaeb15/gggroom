    ...
    <div class="col-md-7">
      <div class="product_details">
        <div class="like_dislike">
          <i class="fa <?php echo $heart; ?> heart_like_dislike" id="like_dislike" data-shopid="<?php echo $this->uri->segment(4); ?>" data-serviceid="<?php echo $servicelist->id; ?>" aria-hidden="true"> SHARE | FAVORITE</i>
          <?php
        ...
        <div class="cmpny_details">
         ...
         <?php 
         if($servicelist->user_id != @$_SESSION['uid']){ ?>
         <div class="bottom_btn_product">

           <?php   
           if($userlist->u_category != 2){?>
           <div class="button_link">
             <a href="<?php echo base_url('chat?id='.$servicelist->user_id); ?>">MESSAGE US</a>
           </div>
         <?php }?>
             <a class="btn-link-a" href="<?=site_url()?>appointment/appointment_step1/<?=$this->uri->segment(3)?>/<?=$this->uri->segment(4)?>"><div class="button_link1">BOOK NOW</div></a>
         </div>
         <?php }?>
    ...
    <div class="container">
      ...
      <div class="owl-carousel owl-theme service_carousel" >
        ...
        <div class="col-md-12 leftbox1">
          <div class="col-md-5">
            <a href="<?=site_url()?>detail/shop_detail/<?=$this->uri->segment(3)?>/<?=$other_service->encrypt_id?>">
          ...
          <div class="col-md-7">
           ...
           <a href="<?=site_url()?>appointment/appointment_step1/<?=$this->uri->segment(3)?>/<?=$other_service->encrypt_id?>" style="color:#fff;"><div class="buttons">Book Now</div></a>
...
$s_start_time = explode(",",$servicelist->start_time);
$s_end_time =  explode(",",$servicelist->end_time);
      ?>
      ...
      <div class="">
        ...
        <table class="table table-striped">
          <?php //foreach ($shop_business_hours_list as $key => $hours_list) {
            $i=0;
                foreach ($s_start_time as $key => $hours_list) {
