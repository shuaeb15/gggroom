        ...
        <div class="edit-form">
          <form action="">
            ...
            <div class="image_change1">
              <img src="<?=base_url()?>front/images/shop.png" alt="" title="" class="img-responsive upload_img" style="width:auto;"/>
            </div>
            <span class=" sub-title text-center" style="margin: 15px 0 15px !important;"><b>No shop found </b></span>
          <div class="col-xs-2 col-sm-2"> </div>
          <div class="col-xs-8 col-sm-8">
            <span class="sub-title text-center" style="margin: 15px 0 55px !important;"> You haven't created any shop yet. Press plus icon for create a new shop </span>
          </div>
          <div class="col-xs-2 col-sm-2"> </div>
        </form>
      </div>
