...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header" style="background:#299494;color:#fff;">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h4 class="modal-title">Write Review</h4>
      </div>
       
      <div class="modal-body" style="background:#f5f5f5;padding:15px 25px;">
        ...
        <hr> </hr>
            ...
            <div class="form-group col-md-6 text-center" style="border-right:1px solid #dcdcdc;">
              <label class="control-label">Worker</label><br>
 ...
 <hr> </hr>
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <textarea class="form-control" rows="4" cols="80" id="add_review" name="add_review" type="text" value="" style="margin:0px 20px;"></textarea>
                </div>
            </div>
      </div>
      <div class="modal-footer" style="background:#299494;">
