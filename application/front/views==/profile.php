  ...
  $( document ).ready(function() {
    var poll_submit = '<?=$userlist->poll_submit?>';
      ...
      $("#finish").click(function(){
        alert("asfd");
        var str = $("#submit_poll").serializeArray();
        $.ajax({
            type: "POST",
            dataType: 'json',
            url: "<?php echo base_url(); ?>Profile/insert_poll/",
            data: str,
  ...
  <div class="modal-dialog">
      ...
      <div class="modal-content">
          <div class="modal-header">
              ...
              <h4 class="modal-title">Please fill up survey to make our product better</h4>
          </div>
          <div id="demo-modal">
          </div>
