            ...
            // echo "<pre>"; print_r($workerlist);exit;
              ...
              ?>
                <div class="col-md-12" style="margin-bottom: 22px;">
                  <input type="checkbox" name="shop_permission" id="shop_permission" <?=($workerlist->shop_permission == 1 ? "checked" : "")?> class="css-checkbox">
                  <label for="shop_permission" class="css-label css-label-check" style="font-size: 23px;">Add Shop Permission</label>
                </div>
                <div class="col-md-12 col-xs-12">
                  <hr class="hr_line margin_bottom_30">
                </div>
                <?php ////////////Add Services Permission////////////// ?>
                <div class="col-md-12" style="margin-bottom: 22px;">
                  <input type="checkbox" name="services_permission" id="services_permission" <?=($workerlist->services_permission == 1 ? "checked" : "")?> class="css-checkbox">
                  <label for="services_permission" class="css-label css-label-check" style="font-size: 23px;">Add Services Permission</label>
                </div>
                <div class="col-md-12 col-xs-12">
                  <hr class="hr_line margin_bottom_30">
                </div>
                <?php ////////////Add Worker Permission////////////// ?>
                <div class="col-md-12" style="margin-bottom: 22px;">
                  <input type="checkbox" name="worker_permission" id="worker_permission" <?=($workerlist->worker_permission == 1 ? "checked" : "")?> class="css-checkbox">
                  <label for="worker_permission" class="css-label css-label-check" style="font-size: 23px;">Add Worker Permission</label>
                </div>
                <div class="col-md-12 col-xs-12">
                  <hr class="hr_line margin_bottom_30">
                </div>
