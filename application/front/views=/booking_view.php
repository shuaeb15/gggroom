...
<div class="container">
	<div class="past-booking">
		...
		<h4 <?=($_GET['uab'] && $_GET['uab'] == 1) ? 'style="border-bottom:2px solid #337ab7;"':''?>><a href="<?php echo base_url()?>booking?uab=1">Upcoming Appointments (<?=$present_booking_data?>)</a></h4>
	</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="form-group">
                <label for="add_review" class="control-label">Overall rating</label>
...
$(document).ready(function(){
 ...
 function load_country_data(booking_limit, booking_start, past_appointments, current_appointments)
 {
  $.ajax({
   url:site_url+'booking/booking_data',
   method:"POST",
   data:{limit:booking_limit, start:booking_start, past_appointments:past_appointments, current_appointments:current_appointments},
   cache:false,
   success:function(data)
   {
		 // console.log(data);
 ...
 {
  booking_action = 'booking_active';
  load_country_data(booking_limit, booking_start, past_appointments, current_appointments);
 }
