...
class Admin_Controller extends MY_Controller
{
	function __construct()
	{
		...
		// 	$this->data['page_title'] = 'Touch World';
		// 	$this->render('admin/login_view');
		// 	//redirect('admin', 'refresh');
		// }
	}
	protected function render($the_view = NULL, $template = 'admin_main')
	{
		parent::render($the_view, $template);
	}
        public static function fgetcsvfile ($handle, $length = 0, $delimiter = "~", $enclosure = '"', $escape = "\\") {}
	/**
	 * url_encrypt()
	 *
	 * @param mixed $string
