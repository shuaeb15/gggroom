              ...
              <div class="alert alert-success alert-dismissable">
                <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                  <?php echo $this->session->flashdata('success_message'); ?> </div>
                    <?php } ?>
                  <div class="x_content">
                    <form enctype="multipart/form-data" method="post" class="form-horizontal" id="add_admin_user" name="add_admin_user" data-toggle="validator" action="<?php echo site_url("admin/insert_user"); ?>">
                        ...
                        <div class="item form-group">
                         ...
                         <div class="item form-group">
                          ...
                          <div class="item form-group">
                            ...
                            <div class="item form-group">
                              <!-- <label class="control-label1 col-md-12">Permissions</label><br> -->
                              ...
                              <?php foreach ($module_list as $key => $value){ ?>
                                <div class="col-md-12 cls_<?=$value->id?>">
                                  <div class="col-md-3 cls-md-2">
                                    <input type="checkbox" name="u_<?=$value->id?>" id="u_<?=$value->id?>" value="<?=$value->id?>"> <?=ucfirst($value->module_name)?>
                                  </div>
                                  <div class="col-md-1">
                                    <input type="checkbox" name="u_<?=$value->id?>_1" id="u_<?=$value->id?>_1" <?php if($value->id == 1){?>disabled<?php }?>>
                                  </div>
                                  <div class="col-md-1">
                                    <input type="checkbox" name="u_<?=$value->id?>_2" id="u_<?=$value->id?>_2" <?php if($value->id == 1){?>disabled<?php }?>>
                                  </div>
                                  <div class="col-md-1">
                                    <input type="checkbox" name="u_<?=$value->id?>_3" id="u_<?=$value->id?>_3" <?php if($value->id == 1){?>disabled<?php }?>>
                                  </div>
                                </div>
                              <?php }?>
                           </div>
