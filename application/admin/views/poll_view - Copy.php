                ...
                <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                  ...
                  <div class="x_content">
                    <form enctype="multipart/form-data" method="post" class="form-horizontal" id="insert_page" name="insert_page" data-toggle="validator" action="<?php echo site_url("page/insert_page"); ?>">
                      <div class="row x_title" id="questionDiv1">
                        <div class="col-md-9 col-xs-12">
                           <div class="item form-group">
                             <label for="">Question 1:</label>
                             <input type="text" name="question" class="form-control">
                             <br>
                             <select class="form-control questionDiv" name="question" id="queOption1" data-value="1">
                               <option value="radio">Radio Button</option>
                               <option value="textarea">Text Area</option>
                             </select>
                             <br>
                              <div class="col-xs-12 radioGroup" id="option1">
                                <div class="col-xs-12 inner-radioGroup">
                                  <input type="radio" name="radio_day" id="radio1" class="css-checkbox radio_day" value="1"/>
                                  <label for="radio1" class="css-label radGroup1 radGroup2">
                                    <span>Option 1</span>
                                  </label>
                                  <input type="text" name="option1" class="form-control" placeholder="Please enter option for your question">
                                  <hr>
                                </div>
                                <i class="fa fa-plus-circle addo" id="add1" title="Add Option" onclick="addOption();"></i><label for="add-option">Add New Radio Button</label>
                                <i class="fa fa-minus-circle remove" id="RemoveButton" title="Add Option"></i><label for="remove-option">Remove Radio Button</label>
                                ...
                                <a href="javascript:void(0);" title="Add New Question" id="add-new-question" style="color:#000; text-decoration:underline; float:right;" data-num="1">Add New Question</a><i class="fa fa-plus-circle" style="float:right;"></i>
                              </div>
                            </div>
                          </div>
                        </div>
