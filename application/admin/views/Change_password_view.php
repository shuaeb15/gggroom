                        ...
                        <form enctype="multipart/form-data" method="post" class="form-horizontal" id="frm_changepassword" name="frm_changepassword" data-toggle="validator" action="<?php echo site_url("Dashboard/change_password"); ?>">
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="position" class="form-control col-md-7 col-xs-12" name="n_password"  placeholder="New Password"  type="text">
                                </div>
                            </div>
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="position" class="form-control col-md-7 col-xs-12" name="c_password"  placeholder="Confirm password"  type="text">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <input type="button" onclick="location.href = '<?php echo base_url(); ?>" class="btn btn-primary" value="Cancel">
