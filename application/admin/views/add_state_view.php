              ...
              <div class="alert alert-success alert-dismissable">
                <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                  <?php echo $this->session->flashdata('success_message'); ?> </div>
                    <?php } ?>
                  <div class="x_content">
                    <form enctype="multipart/form-data" method="post" class="form-horizontal" id="add_state_form" name="add_state_form" data-toggle="validator" action="<?php echo site_url("location/insert_state"); ?>">
                      <div class="col-md-8 col-xs-12 cls_all">
                         <div class="item form-group">
                           <label class="control-label1 col-xs-12" for="product">State name</label><br>
                            <div class="col-xs-12">
                              <input id="state_name" class="form-control col-md-7 col-xs-12" name="state_name" type="text">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-12" style="margin-top:15px;">
                          <input type="checkbox" name="add_state_hours" id="add_state_hours" class="css-checkbox add_state_hours" style="width:15px;height:15px;"/>
                        ...
                        <div class="col-md-12 cls_state_hours" style="margin-top:20px;">
                          ...
                          <div class="col-xs-12 cls-chk">
                            <p id="datepairExample1">
                              ...
                              <input type="text" class="time start ui-timepicker-input cls-time-input" id="hours_start_time" name="hours_start_time"><br>
                              <label class="cl_lbl_time">End Time</label>
                              <input type="text" class="time end ui-timepicker-input cls-time-input" id="hours_end_time" name="hours_end_time">
                        ...
                        <div class="col-md-12" style="margin-top:20px;">
                          ...
                          <div class="col-xs-12 cls-chk">
                            <p id="datepairExample2">
                              <input type="text" class="date start hide">
                              <label class="cl_lbl_time">Start Time</label>
                              <input type="text" class="time start ui-timepicker-input cls-time-input" id="break_hours_start_time" name="break_hours_start_time"><br>
                              <label class="cl_lbl_time">End Time</label>
                              <input type="text" class="time end ui-timepicker-input cls-time-input" id="break_hours_end_time" name="break_hours_end_time">
                              <input type="text" class="date end hide">
                            </p>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="col-md-6 col-md-offset-3" id="eventsExample">
                            ...
                            <button id="send" type="submit" class="btn btn-success cls_btn_state">Add</button>
                          </div>
                        </div>
                      </form>
                    </div>
