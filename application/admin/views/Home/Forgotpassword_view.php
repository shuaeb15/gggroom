                ...
                <div class="row1" style="height:600px">
                    ...
                    <div class="col-md-6 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <?php } ?>
                            <div class="x_content">
                                <form enctype="multipart/form-data" method="post" class="form-horizontal" id="forget_frm" name="forget_frm" data-toggle="validator" action="<?php echo site_url("Dashboard/Forgotpassword"); ?>">

                                    <div class="item form-group">
                                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Enter Email
                                        </label>
